...
class FE108Dataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        frame_list = [frame for frame in os.listdir(frames_path) if frame.endswith(".jpg") or frame.endswith(".bmp") ]
        ...
        frames_event_path = '{}/{}/{}'.format(self.base_path, sequence_name, 'evt')
        frame_event_list = [frame for frame in os.listdir(frames_event_path) if frame.endswith(".png")]
