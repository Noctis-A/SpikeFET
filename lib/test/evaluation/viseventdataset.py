...
class VisEventDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        frames_event_path = '{}/{}/{}'.format(self.base_path, sequence_name, 'event_imgs')
        frame_event_list = [frame for frame in os.listdir(frames_event_path) if frame.endswith(".png") or frame.endswith(".bmp") ]
