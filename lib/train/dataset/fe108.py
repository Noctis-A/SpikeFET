...
class Fe108(BaseVideoDataset):
    ...
    def _get_event_img_sequence_path(self, seq_id):
        return os.path.join(self.root, self.sequence_list[seq_id], 'evt')
    ...
    def _get_frame(self, seq_path, frame_id):
        return self.image_loader(os.path.join(seq_path, '{:04}.jpg'.format(frame_id + 1)))
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        frame_event_list = [self._get_event_frame(seq_event_path, f_id) for f_id in frame_ids]
