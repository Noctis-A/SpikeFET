...
if __name__ == '__main__':
    ...
    data_path = r"/mnt/data/datasets/COESOT_dataset/data/COESOT/train"
    save_path = r"/mnt/data/xxx/COESOT-main/CEUTrack/save/COESOT/train"
    ...
    for videoID in range(len(video_files)):
        ...
        # 训练 2022_03_21_16_11_40
        # 测试 2022_03_21_11_09_50
        if foldName in ['dvSave-2022_03_21_11_09_50', 'dvSave-2022_03_21_16_11_40']:
            print("==>> pass it: ", foldName)
            continue
        fileLIST = os.listdir(os.path.join(data_path, foldName))
        if not os.path.exists(os.path.join(save_path, foldName, foldName+'_evt')):
            os.makedirs(os.path.join(save_path, foldName, foldName+'_evt'))

        evt_save = os.path.join(save_path, foldName, foldName+'_evt/')
