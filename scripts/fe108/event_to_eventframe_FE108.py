...
if __name__ == '__main__':
    ...
    data_path = r"/mnt/data/datasets/FE108_dataset/train"
    save_path = r"/mnt/data/datasets/FE108_dataset/train"
    ...
    for videoID in range(len(video_files)):
        ...
        if not os.path.exists(os.path.join(save_path, foldName, 'evt')):
            os.mkdir(os.path.join(save_path, foldName, 'evt'))
        ...
        frame_all = []
        frame_interval_time = []
        match_file = '/mnt/data/xxx/SpikeFET/scripts/fe108/pair.txt'
        pair = {}
        ...
        # for frame_no in range(0, int(frame_num / dvs_img_interval) - 1):
            ...
            file_output_path_event_time_image_50 = os.path.join(evt_save + 'frame{:0>4d}.png'.format(frame_no-begin_frame))
