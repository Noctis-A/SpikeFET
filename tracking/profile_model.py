...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='spikefet', choices=['spikefet'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='spikefet_visevent_tiny', help='yaml configure file name')
...
def evaluate_vit(model, template, search, template_event, search_event):
    ...
    print('overall macs is ', macs) # 121.241G
...
if __name__ == "__main__":
    ...
    if args.script == "spikefet":
        ...
        template_event = [template_event] * 2
